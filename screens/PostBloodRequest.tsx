...
export default function PostBloodRequest({ navigation }: { navigation: any }) {
  const onPressSkip = () => {
  ...
  return (
    <View style={styles.wrapper}>
      <View style={styles.contentWrapper}>
        ...
        />
        <Text style={styles.postBloodRequest}>Post A Blood Request</Text>
        ...
        <Image
          source={require("../assets/pageTwoIndicator.png")}
        />
      </View>
